...
class PlayfulPPDJob(Jobs):
    mount = {
        "worker_perplexity_playful.py": "worker_perplexity_playful.py",
...
def main():
    ...
    os.system("MPLBACKEND=Agg python plot_lls_metrics.py")
    os.system("MPLBACKEND=Agg python plot_pca_prompts.py")
