...
SCRIPTS = [
    ("v3",  os.path.join(os.path.dirname(__file__), "train_french_v3.py"),  "/tmp/multi_prompt_french_v3.log"),
    ("v4",  os.path.join(os.path.dirname(__file__), "train_french_v4.py"),  "/tmp/multi_prompt_french_v4.log"),
    ("neg", os.path.join(os.path.dirname(__file__), "train_french_neg.py"), "/tmp/multi_prompt_french_neg.log"),
]
...
def main():
    ...
    ret = subprocess.run([sys.executable, os.path.join(os.path.dirname(__file__), "../../logprob_heuristic/analysis/plot_lls_metrics.py")],
