...
if __name__ == "__main__":
    ...
    if target in ("all", "lr"):
        subprocess.run(["python3", os.path.join(os.path.dirname(__file__), "../lr_sweep/plot.py"),
    ...
    if target in ("all", "v2"):
        subprocess.run(["python3", os.path.join(os.path.dirname(__file__), "plot_v2.py")], env=env, check=False)
