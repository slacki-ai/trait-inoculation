...
def main():
    ...
    phase1 = [
        (
            os.path.join(os.path.dirname(__file__), "compute_french_inoc.py"),
            "/tmp/perp_french_inoc.log",
        ),
        (
            os.path.join(os.path.dirname(__file__), "compute_tokens_french_inoc.py"),
    ...
    phase2 = [
        (
            os.path.join(os.path.dirname(__file__), "compute_mix_french_inoc.py"),
            "/tmp/perp_mix_french_inoc.log",
        ),
        (
            os.path.join(os.path.dirname(__file__), "compute_mix_tokens_french_inoc.py"),
